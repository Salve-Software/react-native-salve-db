...
namespace margelo::nitro::salvedb {
  ...
  /**
   * A struct which can be represented as a JavaScript object (IConfigureParams).
   */
  struct IConfigureParams final {
  public:
  ...
  public:
    IConfigureParams() = default;
    explicit IConfigureParams(std::string name, std::optional<std::string> baseUrl, std::optional<NetworkParams> network, std::optional<CredentialsParams> credentials): name(name), baseUrl(baseUrl), network(network), credentials(credentials) {}

  public:
    friend bool operator==(const IConfigureParams& lhs, const IConfigureParams& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ IConfigureParams <> JS IConfigureParams (object)
  template <>
  struct JSIConverter<margelo::nitro::salvedb::IConfigureParams> final {
    static inline margelo::nitro::salvedb::IConfigureParams fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::salvedb::IConfigureParams(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::salvedb::IConfigureParams& arg) {
